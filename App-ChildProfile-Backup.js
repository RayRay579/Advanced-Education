            ...
            <View style={styles.parentHomeContent}>
              <View style={styles.profileCard}>
                <View style={styles.parentSectionHeaderRow}>
                  ...
                  <Text style={styles.parentSectionHeaderSubtle}>Profile details</Text>
                </View>
                <View style={styles.profileInfoGrid}>
                  ...
                  <View style={styles.profileInfoItem}>
                    <Text style={styles.profileInfoLabel}>Group</Text>
                    <Text style={styles.profileInfoValue}>{CHILD_PROFILE.group}</Text>
                  </View>
                  <View style={styles.profileInfoItem}>
                    <Text style={styles.profileInfoLabel}>Status</Text>
                    <View style={styles.parentStatusBadge}>
                      <Text style={styles.parentStatusBadgeText}>{CHILD_PROFILE.status}</Text>
                    </View>
                  </View>
                </View>
              </View>
              ...
              <View style={styles.profileCard}>
                <View style={styles.parentSectionHeaderRow}>
                  ...
                  <Text style={styles.parentSectionHeaderSubtle}>Current programs</Text>
                </View>
              ...
              <View style={styles.profileCard}>
                <View style={styles.parentSectionHeaderRow}>
                  ...
                  <Text style={styles.parentSectionHeaderSubtle}>Approved adults</Text>
                </View>
                <View style={styles.profileBulletList}>
                  {CHILD_PROFILE.authorizedPickups.map((name) => (
                    <Text key={name} style={styles.profileBulletItem}>
                      • {name}
                    </Text>
                  ))}
                </View>
              ...
              <View style={styles.profileCard}>
                <View style={styles.parentSectionHeaderRow}>
                  ...
                  <Text style={styles.parentSectionHeaderSubtle}>Primary contacts</Text>
                </View>
                <View style={styles.profileBulletList}>
              ...
              <View style={styles.profileCard}>
                <View style={styles.parentSectionHeaderRow}>
                  ...
                  <Text style={styles.parentSectionHeaderSubtle}>Important notes</Text>
                </View>
              ...
              >
                <Text style={styles.primaryButtonText}>Back to Parent Home</Text>
              </Pressable>
...
parentHeroPhotoWrap: {
  ...
  parentChildStatusCopy: {
    flex: 1,
    paddingRight: 12,
  },
  parentSectionEyebrow: {
    color: COLORS.blue,
    fontSize: 12,
    fontWeight: '900',
    letterSpacing: 0.8,
